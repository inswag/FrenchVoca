...
//    INSERT INTO subject
//    (subj_koreantitle, subj_frenchtitle, subj_sentence, subj_photo)
//    VALUES
//    ('가족', 'Famile', 'La famille, c''est l''amour sans regrets et sans amertume.', 'mini_famile'),
//    ('건강', 'Santé', 'Une lecture amusante est aussi utile à la santé que l''exercice du corps.', 'mini_santé'),
//    ('교통', 'Transports', 'Bus, train, moto, voiture…', 'mini_transport'),
//    ('기술', 'Technologie', 'La science, c''est ce que le père enseigne à son fils. La technologie, c''est ce que le fils enseigne à son papa.', 'mini_technologie'),
//    ('시간', 'Temps', 'Avec du temps et de la patience, on vient à bout de tout.', 'mini_temps'),
//    ('우정', 'Amitié', 'Offrir l''amitié à qui veut l''amour, c''est donner du pain à qui meurt de soif.', 'mini_amitié'),
//    ('우편', 'Poste', 'Chaque poste où un homme peut servir son pays est honorable.', 'mini_poste'),
//    ('음식', 'Produits alimentaires', 'Mangez, buvez, dormez', 'mini_produits'),
//    ('의류', 'Vêtements', 'Le plus beau vêtement qui puisse habiller une femme, ce sont les bras de l''homme qu''elle aime.', 'mini_vêtements'),
//    ('일상 활동', 'Activités quotidiennes', 'Il est toujours bon d''avoir une activité lente avant de prendre une décision importante.', 'mini_activités'),
//    ('주방', 'Cuisine', 'Il n''y a pas de bonne cuisine si au départ elle n''est pas faite par amitié pour celui ou celle à qui elle est destinée.', 'mini_cuisine');
